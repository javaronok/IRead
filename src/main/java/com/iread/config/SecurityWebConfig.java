...
public class SecurityWebConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/book_update").permitAll()
                .antMatchers(HttpMethod.GET, "/tags").permitAll()
                .antMatchers(HttpMethod.GET, "/download").permitAll()
                .antMatchers(HttpMethod.GET, "/rating_table_full").permitAll()
                .antMatchers(HttpMethod.GET, "/composite_table_full").permitAll()
                .antMatchers(HttpMethod.GET, "/cbf_table_full").permitAll()
                .antMatchers(HttpMethod.GET, "/collaborative_table_full").permitAll()
                .antMatchers(HttpMethod.GET, "/editbook").permitAll()
                .antMatchers(HttpMethod.GET, "/loadbook").permitAll()
